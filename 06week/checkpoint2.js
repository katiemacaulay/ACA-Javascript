...
const nums = strNums.map(element => parseInt(element));
...
const weatherStates = weather.map(value => value.weather_state_name).filter((value, i, arr) => {
...
const idealTempId = weather.find(value => value.min_temp == 15.915).id
